...
export const categoryMutations = {
  SET: {
     ...
     */
    DATA: 'drink/category/SET_DATA',
    /**
     * Used to set the total state of this module
     */
    TOTAL: 'drink/category/SET_TOTAL',
    /**
     * Used to set the query state of this module
     */
    QUERY: 'drink/category/SET_QUERY',
    /**
     * Used to set the current being viewed user
     */
    VIEWING: 'drink/category/SET_VIEWING',
  },
  CLEAR: {
    /**
     * Used to clear the query state of this module to default
     */
    QUERY: 'drink/category/CLEAR_QUERY',
  },
  TOGGLE: {},
  ADD: {
    DATA: 'drink/category/ADD_DATA',
  },
  REMOVE: {},
  INC: {
    /**
     ...
     */
    QUERY_PAGE: 'drink/category/INC_QUERY_PAGE',
  },
  SUB: {
    /**
     * Use to decrease the offset state of this module in query by 1
     */
    QUERY_PAGE: 'drink/category/SUB_QUERY_PAGE',
  },
}
