      ...
      <el-row>
        ...
        <el-row>
          ...
          <el-row class="mt-5">
            ...
            <el-row v-if="payment === 'Transfer'" class="mt-5">
              Bạn vui lòng click vào button thanh toán để tạo đơn hàng.<br />
              Sau đó chuyển khoản vào tài khoản ngân hàng với thông tin bên dưới
              để chúng tôi xác nhận đơn hàng và bắt đầu thực hiện nó!<br />
              <br />
              MB bank chi nhánh TP.Đà Nẵng<br />
              STK: 2340212091999<br />
              Chủ tài khoản: Admin
            </el-row>
          </el-row>
    ...
    onSubmitOrder() {
      if (
        ...
        const payload = {
          ...
          status: 'PENDING',
          userId: this.$store.state.auth.data.id,
        }
